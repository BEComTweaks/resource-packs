...
with open(f"{cdir()}/credits.md","r") as credits:
    ...
    html_end = f'</div><div class="download-container"><div class="file-download"><input type="text" id="fileNameInput" placeholder="Enter Pack name"></div><button class="download-selected-button" onclick="downloadSelectedTweaks()">Download Selected Tweaks</button><div id="selected-tweaks"><div class="tweak-list-pack">Select some packs and see them appear here!</div></div></div><script src="app.js"></script></body><footer style="auto" class="footer-container"><div class="credits-footer">{str(markdown(credit_unformatted))}<p><a href="https://github.com/BEComTweaks/resource-packs">GitHub</a></p></div></footer></html>'
...
stats = [0, 0]
incomplete_packs = {"3D": [], "Aesthetic": [], "Clear Blocks": [], "Crosshairs": [], "Colorful Slime": [], "Elytra": [], "Fixes and Consistency": [], "Fun": [], "GUI": [], "Hearts": [], "Hunger Bars": [], "LGBTQ+ Pride": [], "Lower and Sides": [], "Menu Panoramas": [], "Mobs": [], "More Zombies": [], "Parity": [], "Peace and Quiet": [], "Retro": [], "Terrain": [], "Unobtrusive": [], "Utility": [], "Variation": [], "World of Color": [], "Xisuma's Hermitcraft Bases": []}
dump_json(f"{cdir()}/jsons/others/selected_packs.json", incomplete_packs)
selected_packs = load_json(f"{cdir()}/jsons/others/selected_packs.json")
for i in selected_packs:
    selected_packs[i] = {}
    selected_packs[i]["packs"] = []
    selected_packs[i]["index"] = []
selected_packs["raw"] = []
dump_json(f"{cdir()}/jsons/others/selected_packs.json", selected_packs)
cstats = [0, 0]
compatibilities = {}
conflicts = {}
pkicstats = [0, 0]
...
ignore = False
subcat_list = []
incomplete_pkics = {"3D": [], "Aesthetic": [], "Clear Blocks": [], "Crosshairs": [], "Colorful Slime": [], "Elytra": [], "Fixes and Consistency": [], "Fun": [], "GUI": [], "Hearts": [], "Hunger Bars": [], "LGBTQ+ Pride": [], "Lower and Sides": [], "Menu Panoramas": [], "Mobs": [], "More Zombies": [], "Parity": [], "Peace and Quiet": [], "Retro": [], "Terrain": [], "Unobtrusive": [], "Utility": [], "Variation": [], "World of Color": [], "Xisuma's Hermitcraft Bases": []}
packs = -1
pack_list = []
name_to_json = {}
