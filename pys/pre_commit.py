...
def pre_commit():
    ...
    stats = [0, 0]
    incomplete_packs = {"3D": [], "Aesthetic": [], "Crosshairs": [], "Colorful Slime": [], "Fixes and Consistency": [], "Fun": [], "GUI": [], "Hearts": [], "LGBTQ+ Pride": [], "Lower and Sides": [], "Menu Panoramas": [], "More Zombies": [], "Parity": [], "Peace and Quiet": [], "Retro": [], "Terrain": [], "Unobtrusive": [], "Utility": [], "Variation": []}
    cstats = [0, 0]
    compatibilities = {}
    conflicts = {}
    pkicstats = [0, 0]
    ...
    ignore = False
    subcat_list = []
    incomplete_pkics = {"3D": [], "Aesthetic": [], "Crosshairs": [], "Colorful Slime": [], "Fixes and Consistency": [], "Fun": [], "GUI": [], "Hearts": [], "LGBTQ+ Pride": [], "Lower and Sides": [], "Menu Panoramas": [], "More Zombies": [], "Parity": [], "Peace and Quiet": [], "Retro": [], "Terrain": [], "Unobtrusive": [], "Utility": [], "Variation": []}
    packs = -1
